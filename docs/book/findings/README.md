...
- [2026-06-23 — Curated-reference rewards & the SAME-L steerability map](2026-06-23-curated-reference-rewards-and-the-same-l-steerability-map.md) — three runs: Audiobox aesthetics are a genre-biased **collapse-floor, not a reward**; a **curated reference set is a genre-neutral reward** (MERT-separation AUC 0.999 vs default output, ~0.87 within-genre at layers 5–6); and the **measured SAME-L steerability map** (spectral easy ~0.8, rhythm hard — **downbeat R² 0.16**, which *explains the riffer's rhythm-transfer failure*). Plus the multi-band MERT-conditioner design and the MERT-vs-SAME-L probe that gates it. Advances Sourcebook §Ch13 (relational head) / §Ch8 (conditioner).
